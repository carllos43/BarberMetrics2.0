...
export function AppLayout() {
  ...
  return (
    <div className="min-h-[100dvh] w-full bg-black text-white relative flex flex-col overflow-hidden">
      ...
      <div className="flex-1 w-full max-w-md mx-auto relative flex flex-col bg-black md:shadow-2xl md:border-x md:border-white/5">
        <Header />
        
        <main className="flex-1 overflow-y-auto overflow-x-hidden pt-14 pb-20 relative">
          <AnimatePresence mode="wait" initial={false}>
            <motion.div
              ...
              className="absolute inset-0 pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)]"
            >
